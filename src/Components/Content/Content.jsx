    ...
    <div className="content">
      ...
      <div className="kanan">
        ...
        <div className="search">
          ...
          <div className="bing">
            <img src="src/assets/Bing.jpg" alt="" />
            <h3>Bing</h3>
          </div>
          <div className="yahoo">
            <img src="src/assets/Yahoo.jpg" alt="" />
            <h3>Yahoo</h3>
          </div>
        </div>
        ...
        <div className="os">
          <div className="windows">
            <img src="src/assets/Windows.jpg" alt="" />
            <h3>Microsoft Windows</h3>
          </div>
          <div className="macos">
            <img src="src/assets/MacOS.jpg" alt="" />
            <h3>MacOS</h3>
          </div>
          <div className="linux">
            <img src="src/assets/Linux.jpg" alt="" />
            <h3>Linux</h3>
          </div>
        </div>
